  ...
  return (
    ...
    >
        ...
        <View className="flex-row justify-center">
           ...
           style={{width:wp(97), height:hp(50), borderRadius:15, 
        ...
        {/* back button */}
        <Animated.View entering={FadeIn.delay(200).duration(1000)} className='w-full absolute flex-row justify-between items-center pt-4'>
